...
- Implement the third iteration of **AI Editor** with a new UX to make fact-checking even easier and add new features
...
- The first **Intelligent Text Editor** prototype with HTML, Javascript and CSS
